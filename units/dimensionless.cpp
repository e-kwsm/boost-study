...
int main() {
  ...
  constexpr auto millimeter_by_millimeter{millimeter / boost::units::si::milli / boost::units::si::meter};
  ...
  // ill-formed
  // std::cout fmt % << "dimensionless(1 m  / s )" % dimensionless_t{meter_by_second};
  ...
  std::cout << fmt % "dimensionless(1 m  / mm).value()" % dimensionless_t{meter_by_millimeter}.value();
  std::cout << fmt % "dimensionless(1 mm / m ).value()" % dimensionless_t{millimeter_by_meter}.value();
  std::cout << fmt % "dimensionless(1 mm / mm).value()" % dimensionless_t{millimeter_by_millimeter}.value();
