...
int main() {
  ...
  constexpr length_t millimeter{1.0 * boost::units::si::milli *
                                boost::units::si::meter};
  constexpr auto meter_by_meter{meter / boost::units::si::meter};
  constexpr auto meter_by_millimeter{meter / boost::units::si::milli /
                                     boost::units::si::meter};
  ...
  std::cout << fmt % "dimensionless(1 m  / m )" %
                   dimensionless_t{meter_by_meter};
  std::cout << fmt % "dimensionless(1 m  / mm)" %
                   dimensionless_t{meter_by_millimeter};
  // ill-formed
  // std::cout fmt % << "dimensionless(1 m  / s )" %
  // dimensionless_t{meter_by_second};
  std::cout << fmt % "dimensionless(1 mm / m )" %
                   dimensionless_t{millimeter_by_meter};
  std::cout << fmt % "dimensionless(1 mm / mm)" %
                   dimensionless_t{millimeter_by_millimeter};
  std::cout << fmt % "dimensionless(1 m  / m ).value()" %
                   dimensionless_t{meter_by_meter}.value();
